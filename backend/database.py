...
# USERS
  ...
  demo = User(id = 555, username = 'Demo User', email = 'demo@demo.com', password = 'password', avatar = "https://capstone-project-steven-2.s3-us-west-1.amazonaws.com/clarencedl.png", personal_video = 'quickpitch2.mp4', about_me = "This is a Demo account, but I really aspire to be a SWOLE demo account.  In order to accomplish this I'm going to start uploading tons of lifting videos.  After improving due to all the comments on those videos, I'll undo the damage my stress-eating due to coding problems has done in no time.  (Not so many videos that my AWS gets charged though!)") 
