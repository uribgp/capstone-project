...
# USERS
  ...
  video3 = Video(title = 'hello', description = "it's me", link = '555/videos/VID_20201008_212621996.mp4', thumbnail = "https://capstone-project-steven-2.s3-us-west-1.amazonaws.com/clarencedl.png", owner_id = 3, staff_pick = True)
  video4 = Video(title = 'hello', description = "it's me", link = '555/videos/VID_20201008_212621996.mp4', thumbnail = "https://capstone-project-steven-2.s3-us-west-1.amazonaws.com/clarencepress.png", owner_id = 2, staff_pick = True, total_comments = 1)
  video5 = Video(title = 'video2', description = "asdfasdf", link = '555/videos/VID_20201008_212621996.mp4', owner_id = 3, thumbnail = "https://capstone-project-steven-2.s3-us-west-1.amazonaws.com/lu1.png", new_comment = True)
  ...
  video7 = Video(title = 'hello', description = "it's me", link = '555/videos/VID_20201008_212621996.mp4', owner_id = 555, staff_pick = True, thumbnail = "https://capstone-project-steven-2.s3-us-west-1.amazonaws.com/olympicDL.png")
  ...
  comment1 = Comment(title = 'comment1', text = 'Are your hips beginning to rise while the barbell lags behind?  Will that result in unnecessary strain on your lower back because you end up doing a goodmorning instead of a proper squat?', timestamp = 12, video_id = 1, user_id = 1)
